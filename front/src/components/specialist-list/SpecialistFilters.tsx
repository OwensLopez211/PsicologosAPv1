...
const SpecialistFilters: FC<SpecialistFiltersProps> = ({ 
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-6">
        {/* Header con contador e información */}
        <div className="flex flex-col space-y-6">
          <div className="flex items-center">
            <div className="w-10 h-10 rounded-full bg-[#2A6877]/10 flex items-center justify-center mr-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="relative">
              <select
                className="w-full appearance-none text-sm border border-gray-200 rounded-lg px-4 py-2.5 bg-white hover:border-[#2A6877] transition-colors focus:outline-none focus:ring-2 focus:ring-[#2A6877] focus:border-transparent"
            ...
            {activeFilters.length > 0 && (
              <button
                ...
                className="w-full text-sm text-[#2A6877] border border-[#2A6877] rounded-lg px-4 py-2.5 bg-white hover:bg-[#2A6877]/10 transition-colors flex items-center justify-center gap-2"
              >
