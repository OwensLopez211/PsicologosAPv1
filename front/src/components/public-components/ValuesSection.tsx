...
const ValuesSection = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white to-[#f8fdfb] relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#2A6877] opacity-5 rounded-full transform translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#B4E4D3] opacity-5 rounded-full transform -translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-block p-4 bg-[#2A6877] bg-opacity-10 rounded-full mb-6 shadow-inner">
            <svg className="w-9 h-9 text-[#2A6877]" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd" />
              <path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z" />
            </svg>
          </div>
          <h2 className="text-3xl font-bold text-[#2A6877] mb-6">Lo Que Nos Define</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Nuestros valores básicos son <span className="text-[#2A6877] font-medium">empatía</span>, <span className="text-[#2A6877] font-medium">valentía</span> y <span className="text-[#2A6877] font-medium">superación personal</span>. 
          ...
          {values.map((value, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-[#2A6877] mb-4 text-center">{value.title}</h3>
