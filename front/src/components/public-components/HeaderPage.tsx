...
const HeaderPage = ({
  ...
  return (
    <div className="relative w-full overflow-hidden mt-0 sm:mt-10">
      ...
      {/* Contenido principal */}
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16 lg:py-20 text-center">
