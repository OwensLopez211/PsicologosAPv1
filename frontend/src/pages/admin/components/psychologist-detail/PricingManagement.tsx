...
const PricingManagement: React.FC<PricingManagementProps> = ({
  ...
  return (
    <motion.div 
      ...
      className="mt-8 bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl"
    >
      <div className="bg-gradient-to-r from-[#2A6877] to-[#3a8a9e] text-white px-4 sm:px-6 py-4 sm:py-5 flex justify-between items-center">
        <div className="flex items-center">
          <div className="bg-white/20 p-2 rounded-lg mr-3">
            <CurrencyDollarIcon className="h-5 w-5 sm:h-6 sm:w-6" />
          </div>
          <h2 className="text-lg sm:text-xl font-semibold">Gestión de Precios</h2>
        </div>
        <button 
          onClick={handleRefresh}
          disabled={refreshing}
          className="bg-white/10 hover:bg-white/20 p-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/50"
      ...
      <div className="p-4 sm:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <motion.div 
            ...
            className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md"
          >
            <h3 className="text-gray-700 font-medium mb-2 sm:mb-3 flex items-center">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2 sm:mb-3">
              {suggestedPrice !== null ? formatCurrency(suggestedPrice) : 
                <span className="text-gray-400 text-xl italic">No establecido</span>}
            </p>
            {suggestedPrice !== null && (
              <motion.button
                ...
                className="mt-2 text-sm bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg transition-all duration-200 shadow-sm hover:shadow flex items-center focus:outline-none focus:ring-2 focus:ring-blue-300"
              >
              ...
              {isEditing ? (
                ...
                >
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="border border-gray-300 rounded-lg py-2 pl-8 pr-3 w-full text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent transition-all duration-200"
                      placeholder="Precio"
                      autoFocus
                    />
                  </div>
                  <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="bg-green-500 hover:bg-green-600 text-white p-2 rounded-lg transition-all duration-200 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-green-300 disabled:opacity-50"
                  >
                    {loading ? (
                  ...
                  <motion.button
                    ...
                    className="bg-red-500 hover:bg-red-600 text-white p-2 rounded-lg transition-all duration-200 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-red-300"
                  >
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={handleEditToggle}
                    className="bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 p-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-300"
                    title="Editar precio"
                  >
        ...
        <motion.div 
          ...
          className="mt-6 sm:mt-8 text-sm text-gray-600 bg-blue-50 p-4 rounded-lg border border-blue-100"
        >
          <h4 className="font-medium text-blue-700 mb-2">Información importante</h4>
