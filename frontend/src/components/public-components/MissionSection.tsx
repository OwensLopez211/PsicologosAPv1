      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center mb-8 gap-4">
            <div className="w-16 h-16 rounded-full bg-[#FF6B6B] bg-opacity-10 flex items-center justify-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-white rounded-2xl shadow-xl p-8 mb-12 border-l-4 border-[#FF6B6B] relative overflow-hidden"
          >
            {/* Decorative Element */}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Desestigmatización</h3>
              </div>
              <p className="text-gray-600 ml-16">
                Trabajamos activamente para cambiar la percepción social sobre la salud mental, 
                normalizando la atención psicológica como parte esencial del bienestar integral 
                y educando a la comunidad sobre su importancia.
              </p>
            </motion.div>
          </div>
        </motion.div>
